...
<title><spring:message code="title" /> Upload Certificate</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><a href="#">Upload certificate</a></li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<form:form id="upload-certificate-form" method="POST"
							action="${app}/upload_certificate?${_csrf.parameterName}=${_csrf.token}"
							enctype="multipart/form-data">
							<div class="box-body">
								<div class="form-group">
									<label>Certificate: </label> <input type="file"
