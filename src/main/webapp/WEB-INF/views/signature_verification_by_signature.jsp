	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Signature verification by user signature</h1>
				<ol class="breadcrumb">
			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Signature verification by user
							signature</h3>
					...
					<div class="box-body">
						<c:if test="${success == true}">
							<div class="alert alert-success alert-dismissible">
								...
								Your signature was successfully verified!<br /> This document
								was signed by: <b>${user.firstname} ${user.lastname}</b>
							</div>
						</c:if>
						...
						<form id="sign_text" method="POST"
							action="${app}/signature_verification_by_signature?${_csrf.parameterName}=${_csrf.token}"
