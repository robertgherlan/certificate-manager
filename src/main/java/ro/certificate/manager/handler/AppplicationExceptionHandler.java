...
public class AppplicationExceptionHandler {
	...
	public String customExceptions(InternalServerError ex, HttpServletRequest request,
	...
	@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR)
	public String userNotFoundExceptions(UserNotFoundException ex, HttpServletRequest request,
			RedirectAttributes redirectAttributes) {
		logger.error(ex.getMessage());
		redirectAttributes.addFlashAttribute("error", "Cannot process your request: " + ex.getMessage());
		return "redirect:/500";
	...
	@ResponseStatus(value = HttpStatus.PRECONDITION_FAILED)
	public String multipart(MultipartException ex, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		logger.error(ex.getMessage());
		redirectAttributes.addFlashAttribute("Cannot process your request: ", ex.getMessage());
		return "redirect:/503";
	}
	...
	@ResponseStatus(value = HttpStatus.PRECONDITION_FAILED)
	public String uploadSizeExceed(MaxUploadSizeExceededException ex, HttpServletRequest request,
			RedirectAttributes redirectAttributes) {
		logger.error(ex.getMessage());
		redirectAttributes.addFlashAttribute("Cannot process your request: ", ex.getMessage());
		return "redirect:/503";
	...
	@ResponseStatus(value = HttpStatus.PRECONDITION_FAILED)
	public String debug(Exception ex, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		logger.error(ex.getMessage());
		redirectAttributes.addFlashAttribute("Cannot process your request: ", ex.getMessage());
		return "redirect:/503";
	}
