...
public class RegisterController extends BaseController {
	...
	public String addUserPagePost(Model model, @Valid @ModelAttribute("registerUser") UserRegistrationForm registerUser,
		...
		try {
			...
			velocityContext.put("linkToValidate", configurationUtils.getSiteHomeURL() + "/validateEmail?registerToken="
					+ user.getRegisterToken() + "&email=" + user.getEmail());
			velocityContext.put("username", user.getUsername());
			velocityContext.put("password", plainPassword);
			emailUtils.sendEmail(configurationUtils.getEmail(), user.getEmail(), "Validate account",
	...
	public String validateAccount(Model model,
		...
		emailUtils.sendEmail(email, user.getEmail(), "Your email was validated successfully", "mailAcountValidated.vm",
				velocityContext);
