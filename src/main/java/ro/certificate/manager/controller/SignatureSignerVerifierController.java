...
public class SignatureSignerVerifierController extends BaseController {
	...
	public String sign_documentPOST(Principal principal,
			@RequestParam(value = "documentToSign", required = false) MultipartFile documentToSign,
			@RequestParam("keyStoreID") String keyStoreID, RedirectAttributes redirectAttributes) throws Exception {
	...
	public String signature_verification() throws Exception {
	...
	public String signature_verificationPOST(@RequestParam("signedDocument") MultipartFile signedDocument,
			@RequestParam("signature") MultipartFile signature, RedirectAttributes redirectAttributes) {
		boolean success = false;
	...
	public String signature_verification_by_user(Model model) throws Exception {
		try {
	...
	public String signature_verification_by_user_POST(@RequestParam("signedDocument") MultipartFile signedDocument,
			@RequestParam("user") String userID, RedirectAttributes redirectAttributes) throws Exception {
