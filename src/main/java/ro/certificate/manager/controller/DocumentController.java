...
public class DocumentController extends BaseController {
    ...
    public String myDocumentsSearch(Principal principal,
                                    ...
                                    @RequestParam(required = false, value = "sortBy") String sortBy,
                                    @RequestParam(required = false, value = "query") String query, Model model) {
        Page<Document> myDocuments;
        if (query != null && !query.trim().isEmpty()) {
            myDocuments = documentService.searchByNameAndUser(query.trim(), principal.getName(), pageNumber, perPage, sortDirection, sortBy);
        } else {
    ...
    public void downloadSignature(@RequestParam(value = "documentID") String documentID, @RequestParam(value = "signatureID") String signatureID, HttpServletResponse response) throws Exception {
    ...
    public void downloadDocument(@RequestParam(value = "documentID") String documentID, @RequestParam(value = "userID") String userID, HttpServletResponse response) throws Exception {
