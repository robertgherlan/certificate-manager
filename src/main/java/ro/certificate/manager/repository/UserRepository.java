...
public interface UserRepository extends JpaRepository<User, String> {
	...
	Page<User> findByUsernameOrEmailOrFirstnameOrLastnameAllIgnoreCaseContaining(String userName, String userName1,
			String userName2, String userName3, Pageable pageRequest);
